...
<head>
    ...
    <title>Instantiations of a rule - RuDiK</title>
</head>
...
<div class="container">
    ...
    <thead>
    <tr>
        <th style="text-align: center; font-size: 30px;">Instantiation for rule (${output?size}): <br> <span style="font-size: 20px";> ${instantiatedRule} </span> </th>
    </tr>
    </thead>
    <tbody>
   <#items as rule>
    <tr>
        <td>
            <div class="form-group row" style="margin-left: 15px;">
                <div class="col-sm-12">
                    ${rule}
                    <form action="instantiate-rule/surrounding-graph" >
        ...
        <#else>
             <table>
		<tr>
        <th style="text-align: center; font-size: 30px;">Rule instantiations:  <br> <span style="font-size: 20px";> ${instantiatedRule} </span></th>
    </tr>
               <tr>
                 <td>No rule instantiation found...Please try another rule</td>
               </tr>
</table>
        </#list>
