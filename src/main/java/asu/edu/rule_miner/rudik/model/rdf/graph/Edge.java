...
public class Edge<T> {
  ...
  public String toString() {
    return (this.nodeSource != null ? this.nodeSource.toString() : "")
        + (this.label != null ? this.label.toString() : "") + (this.nodeEnd != null ? this.nodeEnd.toString() : "");
  }

  public T getNodeStart() {
    return isArtificial ? getNodeBottom() : getNodeSource();
  }

  public T getNodeEnd() {
    return isArtificial ? getNodeSource() : getNodeBottom();
  }
